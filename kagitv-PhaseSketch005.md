3️⃣ The Most Flexible Universal Design

To support both models, design your invoice table with invoice type.
...
Small Optional Improvement (Very Useful)

If you want a very ERP-grade system, add this table:

Table ordering.invoice_type {
  code varchar(20) [pk]
